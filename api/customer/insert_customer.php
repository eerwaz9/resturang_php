...
if (isset($_POST["cus_name"])
    ...
    // $cus_latiute=$_POST["cus_latiute"];
    // $cus_latuite=$_POST["cus_latuite"];
    ...
    // array_push($insertArray, htmlspecialchars(strip_tags($cus_latiute)));
    // array_push($insertArray, htmlspecialchars(strip_tags($cus_latuite)));
